...
test('renders learn react link', () => {
  ...
  expect(calculate(300, 0, false)).toBe(270);
  expect(calculate(200, 4, true)).toBe(170);
  expect(calculate(200, 5, true)).toBe(180);
  expect(calculate(200, 6, true)).toBe(180);
  expect(calculate(199.9, 4, true)).toBe(193.9);
  expect(calculate(300, 4, true)).toBe(255);
